  ...
  return (
    <footer className="bg-black" aria-labelledby="footer-heading">
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm text-white font-poppins font-[300] leading-6 tracking-[0.2px] max-w-80">
              ...
              of industry professionals. J.O. Group works to deliver the best
              possible experience with Real Estate.
            </p>
          </div>
              ...
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    ...
                    >
                      <MdKeyboardArrowRight size={20} className="mr-1" />{" "}
                      Marketing
                    </a>
                  </li>
                  <li>
        ...
        <div className="mt-16 border-t border-gray-400/20 pt-8 sm:mt-20 lg:mt-24 flex justify-between">
