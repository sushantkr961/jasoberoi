...
function NavMobile({ setOpen, isOpen }: Props) {
    ...
    return (
        <>
            ...
            <nav
                ref={navRef}
                className={`fixed z-30 top-0 ${isOpen ? 'left-0' : '-left-full'} overflow-hidden h-[100vh] overflow-y-auto bg-[#F7F7F7] items-center justify-between   flex w-auto  transition-all ease-in-out duration-700`}
            >
