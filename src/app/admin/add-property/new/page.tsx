...
const page = () => {
    ...
    return (<div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="bg-white rounded-xl shadow p-4 sm:p-7 border-2   dark:bg-neutral-900">
            <form>

                {/* Property Details Start Here Here */}
                <section id="propertydetails" className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div className="sm:col-span-12">
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-neutral-200">Property Details</h2>
                    </div>

                    {/* Property ID */}
                    <div className="sm:col-span-3">
                        <label htmlFor="af-submit-application-full-name" className="inline-block text-sm font-medium text-gray-500 mt-2.5 dark:text-neutral-500">
                            Property ID
                        </label>
                    </div>
                    ...
                    <div className="col-span-12 ">
                        <fieldset className="border flex flex-col gap-4 border-gray-300 rounded-md p-4">
                            <legend className="text-sm font-medium text-gray-500 px-2">Extra Fields for Property</legend>
                            <p>You can add Your Extra Details Here for example Bedrooms,room...</p>
                            <div className="mt-3  flex justify-end  rounded-sm">
                                <button
                                    className="inline-flex bg-blue-600 rounded-md text-white py-2 px-4 items-center gap-x-1 text-sm decoration-2 hover:underline font-medium "
                                >
                                    <IoAddCircleOutline />
                                    Add More Field
                                </button>
                ...
                <section className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div className="sm:col-span-12">
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-neutral-200">Address</h2>
                    </div>
                    {/* Address  */}
                    <div className="col-span-12 ">
                ...
                <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div className="sm:col-span-12">
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-neutral-200">Description</h2>
                    </div>

                    {/* Hero Image */}
                    <div className="sm:col-span-3">
                        <label htmlFor="af-submit-application-resume-cv" className="inline-block text-sm font-medium text-gray-500 mt-2.5 dark:text-neutral-500">
                ...
                <section className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div className="sm:col-span-12">
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-neutral-200">Slider With Toggle </h2>
                    </div>
                ...
                <section className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div className="sm:col-span-12">
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-neutral-200">Mortgage Calculator </h2>
                    </div>
                    {/* Mortgage Calculator  */}
                    <div className="col-span-12 ">
