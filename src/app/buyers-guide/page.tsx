        ...
        <Container className="m-auto flex flex-col items-center px-2">
          <div className="heading flex flex-col items-center justify-center py-10 md:py-20 sm:px-20 lg:px-24 gap-3 md:gap-8 lg:gap-10  lg:max-w-full">
            <h2 className="font-poppins text-[25px] md:text-[46px] uppercase leading-[1.3em] font-[300] text-center">
              <strong className="font-[600] ">A HASSLE FREE</strong> GUIDE TO
              BUYING
            </h2>
            <p className="text-[#2d2d2d] text-[15xpx] md:text-[22px] font-poppins text-center">
              Buying a home can be one of the grandest and happiest decisions of
              your life. It can also be one of the most complex and demanding
              decisions. To ready you for the upcoming transition, here is a
              general overview of what to expect and prepare.
            </p>
          </div>

          <div
            className=" lg:w-[88%] flex justify-center "
          ...
          <div className="py-10 md:py-18 lg:py-20  md:px-[40px] lg:px-[0px] lg:w-[80%] border-b-2 flex flex-col gap-6  mb-5">
            {guide.guide.map((data, index) => (
              <div key={index} className="">
                <h2 className="font-poppins font-[600] text-center text-[24px] lg:text-left lg:text-[29px] uppercase mb-[11px] ">
                  {data.title}
                </h2>
                {data.contents.map((para) => (
                  <p className="text-center text-[14px] lg:text-left lg:text-[16px] text-[#212111]">
                    {para.content}
                  </p>
                ))}
              </div>
          ...
          <div className="heading w-[97%] sm:w-[70%] lg:w-[54% m-auto flex flex-col items-center justify-center gap-4 py-9 text-center">
            <h2 className="font-poppins text-[35px] md:text-[48px] uppercase leading-[1em] font-[300]">
              <strong className="font-[600] ">WE’D LOVE</strong> TO MEET YOU!
            </h2>
